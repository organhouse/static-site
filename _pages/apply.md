...
<p class="intro">Welcome! If you have been referred to Organ House by an existing member and are interested attending one of our private event, please fill out this application. Information is provided solely to the organizers. We take your privacy extremely seriously and would never share this information.</p>
	...
	<tr><td><span>Want updates?</span><p>We’ll add you to our monthly email about community events and mixers! If your application is approved, we’ll also send you (pretty safe for work) invites to our private events!</p><input type='checkbox' name='Email Opt Out' checked='true'><label style="display:inline;">I enthusiastically consent!</label></input></td></tr>
